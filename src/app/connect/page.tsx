            ...
            <div className="container mx-auto px-4 flex justify-center">
              <div className="max-w-4xl mx-auto text-center relative z-10">
                ...
                <div className="mt-8 sm:mt-10 flex justify-center">
                  <a href="mailto:info@n8nid.com" className="btn-jelajah flex items-center justify-center gap-2 sm:gap-3 px-4 sm:px-6 lg:px-8 py-3 sm:py-4 text-sm sm:text-base lg:text-lg whitespace-nowrap">
                    Connect With Us
                  </a>
                </div>
              </div>
