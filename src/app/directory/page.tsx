...
export default function DirectoryPage() {
  ...
  const filteredCreators = creators.filter((creator) => {
    ...
    const matchesLocation = filterLocation === "all" || creator.location?.toLowerCase().includes(filterLocation.toLowerCase());

    return matchesSearch && matchesExperience && matchesAvailability && matchesLocation;
  });
  ...
  const sortedCreators = [...filteredCreators].sort((a, b) => {
    switch (sortBy) {
      ...
      case "experience":
        ...
        return (experienceOrder[bLevel as keyof typeof experienceOrder] || 0) - (experienceOrder[aLevel as keyof typeof experienceOrder] || 0);
      case "rate":
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-7xl">
      {/* Header */}
      <div className="mb-8">
        <h1 className="text-4xl font-bold mb-2 text-white">Directory Creator</h1>
        <p className="text-gray-600">Temukan dan hubungi creator automation terbaik dari seluruh Indonesia</p>
      </div>
