...
const AboutSection = () => {
  return (
    <section className="relative overflow-hidden w-full" style={{ background: '#201A2C' }}>
          ...
          <div className="container mx-auto px-4 flex justify-center">
            <div style={{ maxWidth: '820px', textAlign: 'center', position: 'relative', zIndex: 2 }}>
              ...
              <div className="mt-10 flex justify-center">
                <a href="/connect" className="btn-jelajah flex items-center gap-3" style={{fontSize: '20px'}}>
                  Connect With Us
                </a>
              </div>
            </div>
        ...
        <div className="w-full mt-24 px-4 md:px-12 relative">
          ...
          <div className="flex flex-col items-start w-full text-left">
            <div className="mb-12 z-10 w-full">
              <h3 className="text-5xl font-thin text-white/80 mb-4" style={{fontFamily: 'Albert Sans, Arial, sans-serif'}}>Key Benefits</h3>
            ...
            <div className="flex flex-col gap-16 w-full z-10">
              {/* Item 1 */}
              <div className="flex items-start gap-4 relative" style={{marginLeft: '60px'}}>
                <div className="flex-shrink-0 w-9 h-9 rounded-full bg-[#C084FC] flex items-center justify-center shadow-lg">
                  <svg width="20" height="20" viewBox="0 0 20 20" fill="none"><circle cx="10" cy="10" r="10" fill="#C084FC"/><path d="M6 10.5L9 13.5L14 8.5" stroke="#fff" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></svg>
                </div>
                <div>
                  <div className="text-xl text-white/90 font-normal mb-1">Share Your Workflow</div>
                  <div className="font-bold text-white text-lg leading-snug">Bagikan workflow Anda untuk membantu kreator lain<br/>menemukan cara kerja yang lebih efisien dan terarah.</div>
                </div>
              </div>
              {/* Item 2 */}
              <div className="flex items-start gap-4 relative" style={{marginLeft: '160px'}}>
                <div className="flex-shrink-0 w-9 h-9 rounded-full bg-[#C084FC] flex items-center justify-center shadow-lg">
                  <svg width="20" height="20" viewBox="0 0 20 20" fill="none"><circle cx="10" cy="10" r="10" fill="#C084FC"/><path d="M6 10.5L9 13.5L14 8.5" stroke="#fff" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></svg>
                </div>
                <div>
                  <div className="text-xl text-white/90 font-normal mb-1">Access Ready-to-Use Workflows</div>
                  <div className="font-bold text-white text-lg leading-snug">Jelajahi berbagai workflow yang praktis dan dapat langsung<br/>Anda terapkan dalam proses kerja Anda.</div>
                </div>
              </div>
              {/* Item 3 */}
              <div className="flex items-start gap-4 relative" style={{marginLeft: '260px'}}>
                <div className="flex-shrink-0 w-9 h-9 rounded-full bg-[#C084FC] flex items-center justify-center shadow-lg">
                  <svg width="20" height="20" viewBox="0 0 20 20" fill="none"><circle cx="10" cy="10" r="10" fill="#C084FC"/><path d="M6 10.5L9 13.5L14 8.5" stroke="#fff" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></svg>
                </div>
                <div>
                  <div className="text-xl text-white/90 font-normal mb-1">Connect & Collaborate</div>
                  <div className="font-bold text-white text-lg leading-snug">Bangun koneksi dan kolaborasi dengan kreator lain untuk<br/>mengembangkan proyek yang lebih maksimal.</div>
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="w-full flex flex-col md:flex-row items-center justify-between gap-8 mt-24 px-4 md:px-12 py-16" style={{background: 'transparent'}}>
