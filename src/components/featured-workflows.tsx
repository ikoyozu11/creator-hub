...
.from("workflows")
  ...
  return (
    <section className="py-8 md:py-16 content-above-gradient">
      <div className="w-full px-4 md:px-8 lg:px-16 relative z-10">
        <div className="flex flex-col items-start justify-start mb-8 md:mb-12">
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between w-full gap-4 md:gap-6">
            ...
            <Link
              href="/workflows"
              className="btn-jelajah flex items-center gap-2 md:gap-3 px-4 md:px-6 py-3 md:py-4 text-sm md:text-base"
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 md:gap-6 lg:gap-8">
          {workflows.length > 0 ? (
            ...
            <div className="col-span-full text-center py-12">
              <div className="text-gray-500 text-lg mb-4">Belum ada workflow yang tersedia</div>
              <Link
                href="/workflows"
                className="btn-jelajah inline-flex items-center gap-2 px-6 py-3 text-sm"
              >
                Jelajahi Workflow
              </Link>
            </div>
